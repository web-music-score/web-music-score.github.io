...
<script src="https://unpkg.com/web-music-score@7.0.0/dist/iife/index.js"></script>

<!-- Or load script via jsDelivr CDN -->
<script src="https://cdn.jsdelivr.net/npm/web-music-score@7.0.0/dist/iife/index.js"></script>
