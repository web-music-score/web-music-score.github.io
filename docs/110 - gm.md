...
Version 6.4.0 added support for General MIDI instruments.

Below is a list of General MIDI instruments.
See [Set Instrument](/docs/create-doc/set-instrument) for instrument usage.
...
# Percussive instruments (112-119) are not supported!
