...
function ExampleCode() {
    const doc = new Score.DocumentBuilder({ color: "red", background: "lightyellow" })
        ...
        .addNote(0, "C4", "4n", { string: 4, color: "blue" }).addAnnotation("staccato", { color: "green" }).addConnective("slur", 2, { color: "blue" })
        .addNote(0, "E4", "4n", { string: 3, color: "blue" }).addAnnotation("staccato", { color: "green" })
        .addNote(0, "G4", "4n", { string: 2, color: "blue" }).addAnnotation("staccato", { color: "green" }).addConnective("slur", 2, { color: "blue" })
